            ...
            <div class="burger-table-row" v-for="burger in burgers" :key="burger.id">
                ...
                <div>
                    <select name="status" class="status" @change="updateStatus($event, burger.id)">
                        ...
                        <option v-for="s in status" :selected="burger.status == s.tipo" :value="s.tipo" :key="s.id">{{s.tipo}}</option>                       
                    </select>
...
import Message from '../components/Message.vue';
    ...
    methods: {
        ...
        async deleteBurger(id) {
            ...
            const data = await req.json();
            this.getPedidos();
            this.msg = 'Burger cancelado com sucesso!';
        ...
        async updateStatus(event, id) {
            ...
            const data = await req.json();
            this.getPedidos();
            this.msg = `O pedido ${id} foi atualizado com sucesso para ${data.status}!`;
